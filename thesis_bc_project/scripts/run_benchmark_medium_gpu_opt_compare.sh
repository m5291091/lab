...
RESULT_DIR="${BUILD_DIR}/result_benchmark_medium_gpu_opt_compare_${TIMESTAMP}_${JOB_SUFFIX}"
mkdir -p "${RESULT_DIR}"
...
log "╔══════════════════════════════════════════════════════════════╗"
log "║  Miyabi-G gpu_opt / gpu_opt_pure_chunked ベンチマーク (medium) ║"
log "╠══════════════════════════════════════════════════════════════╣"
