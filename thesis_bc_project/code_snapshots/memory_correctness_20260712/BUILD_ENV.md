# BUILD_ENV — memory_correctness_20260712

**用途**: memory-path 正確性 canonical（比較行列）

- SourceSnapshotID: `memory_correctness_20260712`
- 元 commit（監査用対応表 `../_legacy_audit/LEGACY_COMMIT_TO_SNAPSHOT.tsv`）: 参照
- 実験対象: correctness/memory_paths（canonical）
- PBS job ID: `2368587.opbs`
- queue: regular-g(→ small-g 100GiB)
