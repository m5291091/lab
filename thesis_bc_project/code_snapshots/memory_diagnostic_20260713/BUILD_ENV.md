# BUILD_ENV — memory_diagnostic_20260713

**用途**: memory-path 診断（T-RESET/T-NSEFF）

- SourceSnapshotID: `memory_diagnostic_20260713`
- 元 commit（監査用対応表 `../_legacy_audit/LEGACY_COMMIT_TO_SNAPSHOT.tsv`）: 参照
- 実験対象: correctness/memory_paths（diagnostic）
