# BUILD_ENV — small_correctness_20260712

**用途**: small full-vector correctness（独立参照）

- SourceSnapshotID: `small_correctness_20260712`
- 元 commit（監査用対応表 `../_legacy_audit/LEGACY_COMMIT_TO_SNAPSHOT.tsv`）: 参照
- 実験対象: correctness/small_full_vector
...
- グラフ入力 `data/`（実行時; `data/benchmark_11023_62184`, `data/benchmark_7000_41459`, `data/chain_200`）
...
|:--|:--|:--|:--|:--|:--|:--|:--|
| chain_200 | `data/chain_200` | `8fe3b0e05de9eecb9999962374ce843264d040b985e85e7ddc7bfd987494db79` | 200 | 199 | undirected | unknown | tools/gen_graph.py 生成 (鎖状) |
