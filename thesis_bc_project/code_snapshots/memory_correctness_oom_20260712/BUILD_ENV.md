# BUILD_ENV — memory_correctness_oom_20260712

**用途**: memory-path 正確性（UM b10240 OOM）

- SourceSnapshotID: `memory_correctness_oom_20260712`
- 元 commit（監査用対応表 `../_legacy_audit/LEGACY_COMMIT_TO_SNAPSHOT.tsv`）: 参照
- 実験対象: unsuccessful/oom
- PBS job ID: `2368269.opbs`
- queue: small-g(100GiB, mem 制限)
